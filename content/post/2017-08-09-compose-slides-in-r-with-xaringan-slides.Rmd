...
Last week I wrote on the eternal verities of [R Markdown](/post/2017-08-03-rmarkdown/).  This post covers a slide presentation package in R: Xaringan slides, one of the many awesome report formats enabled by R Markdown.^[To be complete:  library(Xaringan) + R Markdown + R +  RStudio. For more information, see [R Markdown](/post/2017-08-03-rmarkdown/)]  With Xaringan, incorporating slides into my workflow becomes a natural and critical step in reproducible data science.  
...
Visually the default slide style is spare, almost austere, but given how most slides are too cluttered ^[[The Art of Slide Design](https://speakerdeck.com/mseckington/the-art-of-slide-design)] I find this an inspiring advantage.  The installed Xaringan package comes with a standard CSS style sheet that can be used without modification or can be customized to suite personal needs.^[Video:  [Learn CSS in 12 Minutes](https://www.youtube.com/watch?v=0afZj1G0BIE)]  This slide package ensures the authoring phase becomes part of a more nimble and reproducible life cycle  (analysis, authoring, storing, and archiving) while enabling you to document your slides with literate code.  Notably, you do not have to be a coder to take advantage of this approach.  Xaringan slides can be authored with the same ease as any normal or more proprietary slide tools.  Just spend 20 seconds learning [R Markdown](/post/2017-08-03-rmarkdown/) and you'll be ready to increase your RQ ("Reproducibility Quotient") in no time.  

I will note that I was a bit daunted by the CSS.  But after composing a few slides decks I was inspired to make a custom CSS style sheet to reflect the [Duke color pallette](https://styleguide.duke.edu/color-palette/).  I now use that CSS as my base template and modify as necessary.  My customization with the Duke color pallette is now a second CSS file and can be called with any Xaringan slide deck.  The whole package ^[It's not actually a package, only a repo.  I'll have to work on that.] is [available on Github](https://github.com/libjohn/slide-template-dukeu) and ripe for collaboration.  Feel free to clone or fork. 
